...
namespace Vision2.UI.DataGridViewF
{
    ...
    public class DataGridViewNumericUpDownCell : DataGridViewTextBoxCell
    {
        ...
        /// <summary>
        /// 将当前 DataGridView EditingControl 作为 DataGridViewNumericUpDownEditingControl 控件返回
        ...
        /// KeyEntersEditMode 函数的自定义实现。此函数由 DataGridView 控件调用
        ///以决定击键是否必须启动编辑会话。在这种情况下，在以下情况下启动新会话：
        ///键入数字或负号键。
        /// </summary>
        ...
        /// <summary>
        /// 由 Paint 函数调用的小实用程序函数，用于查看是否需要绘制特定零件。
        ...
        /// 位置编辑控件的自定义实现，当它被 DataGridView 控件调用时需要重新定位和/或调整编辑控件的大小。
        /// </summary>
                                            ...
                                            bool isFirstDisplayedRow)
        {
            ...
            this.paintingNumericUpDown.Value = paintingNumericUpDown.Value;
        }
