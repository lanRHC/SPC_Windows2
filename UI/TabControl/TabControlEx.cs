...
namespace Vision2.UI
{
    ...
    public class TabControlEx : TabControl
    {
        ...
        [DefaultValue(typeof(Color), "166, 222, 255"),
            DescriptionAttribute("TabPaes背景色"), Category("自定义颜色")]
        ...
        [DescriptionAttribute("启动关闭按钮"), Category("自定义属性"), DefaultValue(true)]
        ...
        [DefaultValue(typeof(Color), "234, 247, 254"),
            DescriptionAttribute("背景色"), Category("自定义颜色")]
        ...
        [DefaultValue(typeof(Color), "23, 169, 254"),
            DescriptionAttribute("边框色"), Category("自定义颜色")]
        ...
        [DefaultValue(typeof(Color), "0, 95, 152"),
            DescriptionAttribute("箭头的颜色"), Category("自定义颜色")]
        ...
        private const int CLOSE_SIZE = 13;
        ...
        #endregion UpDownButtonNativeWindow
